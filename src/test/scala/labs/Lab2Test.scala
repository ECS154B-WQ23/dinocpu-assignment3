...
class NextPCBrTester(c: ControlTransferUnit) extends PeekPokeTester(c) {
  private val ctl = c
  
  val tests = List(
    // controltransferop, operand1, operand2,   funct3,     pc,   imm, nextpc,   taken
    (                3.U,     13.U,      9.U, "b000".U,   20.U,  16.U,   24.U, false.B,  "beq0"),
    (                3.U,    133.U,    133.U, "b000".U,   20.U,  16.U,   36.U,  true.B,  "beq1"),
    (                3.U,     13.U,      9.U, "b001".U,   20.U,  16.U,   36.U,  true.B,  "bne"),
    (                3.U,     13.U,      9.U, "b100".U,   20.U,  16.U,   24.U, false.B,  "blt"),
    (                3.U,     13.U,      9.U, "b101".U,   20.U,  16.U,   36.U,  true.B,  "bge"),
    (                3.U,     13.U,      9.U, "b110".U,   20.U,  16.U,   24.U, false.B,  "bltu"),
    (                3.U,     13.U,      9.U, "b111".U,   20.U,  16.U,   36.U,  true.B,  "bgeu")
  )

  for (t <- tests) {
    poke(ctl.io.controltransferop, t._1)
    poke(ctl.io.operand1, t._2)
    poke(ctl.io.operand2, t._3)
    poke(ctl.io.funct3, t._4)
    poke(ctl.io.pc, t._5)
    poke(ctl.io.imm, t._6)
    step(1)
    expect(ctl.io.nextpc, t._7, s"${t._9} wrong")
    expect(ctl.io.taken,  t._8, s"${t._9} wrong")
  }
}
...
class NextPCBranchTesterLab2 extends ChiselFlatSpec {
  "NextPC" should s"match expectations for each intruction type" in {
    Driver(() => new ControlTransferUnit) {
      c => new NextPCBrTester(c)
    } should be (true)
  }
}

class NextPCJalTester(c: ControlTransferUnit) extends PeekPokeTester(c) {
  private val ctl = c
  val tests = List(
    // controltransferop, operand1, operand2,   funct3,     pc,   imm, nextpc,   taken
      (              1.U,     13.U,      9.U, "b000".U,   60.U,  16.U,   76.U,  true.B, "jal0"),
      (              1.U,    133.U,    133.U, "b000".U,   40.U,   8.U,   48.U,  true.B, "jal1")
  )
...
class NextPCJalrTester(c: ControlTransferUnit) extends PeekPokeTester(c) {
  private val ctl = c

  val tests = List(
    // controltransferop, operand1, operand2,   funct3,     pc,   imm, nextpc,   taken
    (                2.U,     44.U,     99.U,      0.U,  100.U,  16.U,   60.U,   true.B, "jalr0"),
    (                2.U,    112.U,     19.U,      0.U,   56.U,  12.U,  124.U,   true.B, "jalr1")
  )
...
class NextPCTester(c: ControlTransferUnit) extends PeekPokeTester(c) {
  private val ctl = c

  val tests = List(
    // controltransferop, operand1, operand2,   funct3,     pc,   imm, nextpc,   taken
    (                0.U,    143.U,     92.U, "b000".U,  200.U, 164.U,  204.U, false.B, "none0"),
    (                3.U,     13.U,      9.U, "b000".U,   20.U,  16.U,   24.U, false.B,  "beqF"),
    (                3.U,    133.U,    133.U, "b000".U,   28.U,  40.U,   68.U,  true.B,  "beqT"),
    (                3.U,     11.U,      7.U, "b001".U,   36.U,  12.U,   48.U,  true.B,  "bneT"),
    (                3.U,     14.U,     14.U, "b001".U,   52.U,   8.U,   56.U, false.B,  "bneF"),
    (                3.U,     13.U,      9.U, "b100".U,   24.U,  20.U,   28.U, false.B,  "bltF"),
    (                3.U,      5.U,      7.U, "b100".U,   12.U,   8.U,   20.U,  true.B,  "bltT"),
    (                3.U,    130.U,    130.U, "b101".U,   24.U,  16.U,   40.U,  true.B,  "bgeT"),
    (                3.U,     13.U,     94.U, "b101".U,   28.U,  16.U,   32.U, false.B,  "bgeF"),
    (                3.U,     13.U,      9.U, "b110".U,   20.U,  16.U,   24.U, false.B, "bltuF"),
    (                3.U,      4.U,      8.U, "b110".U,    4.U,  24.U,   28.U,  true.B, "bltuT"),
    (                0.U,    151.U,     55.U, "b000".U,  164.U,  12.U,  168.U, false.B, "none1"),
    (                3.U,     13.U,      9.U, "b111".U,   20.U,  16.U,   36.U,  true.B, "bgeuT"),
    (                3.U,     11.U,    117.U, "b111".U,   68.U,  16.U,   72.U, false.B, "bgeuF"),
    (                1.U,     13.U,      9.U, "b000".U,  204.U,  16.U,  220.U,  true.B,  "jal0"),
    (                1.U,    133.U,    133.U, "b000".U,  208.U,   8.U,  216.U,  true.B,  "jal1"),
    (                2.U,    100.U,    919.U, "b000".U,  100.U,  16.U,  116.U,  true.B, "jalr0"),
    (                2.U,    116.U,    119.U, "b000".U,   56.U,  12.U,  128.U,  true.B, "jalr1")
  )
